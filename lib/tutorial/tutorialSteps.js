 ...
 * Defines the 16-step interactive tutorial for Weavink dashboard
 *
 * Step Flow:
 ...
 * 12. Tutorial Progression - Tutorial progress tracking section
 * 13. Create Link - Highlight Add Link button, wait for user click
 * 14. Link Form - Highlight opened form
 * 15. Appearance Customization - Auto-navigate to /dashboard/appearance
 * 16. Completion - Success message
 */
...
export const getTutorialSteps = (t) => [
  ...
  // ============================================
  // STEP 13: CREATE LINK (Wait for User Action)
  // ============================================
  {
  ...
  // ============================================
  // STEP 15: APPEARANCE CUSTOMIZATION (Auto-navigate)
  // ============================================
  {
