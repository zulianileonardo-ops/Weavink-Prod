...
export class EmailService {
     ...
     * @returns {Promise<{success: boolean, messageId: string}>}
     */
    static async sendContactDeletionCancelledEmail(recipientEmail, recipientName, cancelledUserName, locale = 'en') {
        try {
            const translations = loadTranslations(locale);
...
`;
     ...
     * @private
     */
    static _generateContactDeletionCancelledTemplate(recipientName, cancelledUserName, locale, translations) {
        const t = translations.emails?.contact_deletion_cancelled || {};
