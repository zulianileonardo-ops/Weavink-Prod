...
function startGlobalFirestoreListener(userId) {
    ...
    const userRef = doc(fireApp, 'users', userId);
...
export class AppearanceService {
     ...
     * @returns {Promise<Object>} Upload result with downloadURL
     */
    static async uploadMediaImage(file) {
        return this._uploadFile(file, 'mediaImage');
    }
     ...
     * @returns {Promise<Object>} Upload result with downloadURL
     */
    static async uploadMediaVideo(file) {
        return this._uploadFile(file, 'mediaVideo');
    }
