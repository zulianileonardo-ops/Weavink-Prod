  ...
  static async addStepToSession({ userId, sessionId, stepData }) {
    ...
    try {
      ...
      const step = {
        ...
        // Budget tracking
        budgetExceeded: stepData.budgetExceeded || false,
        budgetExceededReason: stepData.budgetExceededReason || null,

        metadata: {
          ...stepData.metadata,

          // Budget context
          budgetCheck: stepData.budgetCheck || null
        }
      };
      ...
      // Track if any step exceeded budget
      if (stepData.budgetExceeded) {
        sessionUpdate.budgetExceeded = true;
        sessionUpdate.budgetExceededAt = FieldValue.serverTimestamp();
        sessionUpdate.budgetExceededReason = stepData.budgetExceededReason;
      }
