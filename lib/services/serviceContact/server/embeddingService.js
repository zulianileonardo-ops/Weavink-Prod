...
export class EmbeddingService {
   ...
   * @param {string} options.inputType - Cohere input type: 'search_document' (for storing) or 'search_query' (for querying)
  ...
  static async generateEmbedding(text, options = {}) {
    const {
      ...
      inputType = 'search_document'  // Default to 'search_document' for backward compatibility
    } = options;
  ...
  static async batchGenerateEmbeddings(texts, options = {}) {
    const {
      ...
      onProgress = null,
      inputType = 'search_document'  // Default to 'search_document'
    } = options;
