...
// Test Case 2: Semantic match with summary field (the fix)
const testCase2 = {
  query: "React developers",
  documents: [
    "name: Alice Smith\njob_title: Software Engineer\ncompany: Tesla\ntags: frontend, engineering\nsummary: Software Engineer | frontend, engineering | at Tesla",
    "name: Bob Jones\njob_title: Autopilot Engineer\ncompany: Tesla\nsummary: Autopilot Engineer | at Tesla",
    "name: Carol Davis\njob_title: Sales Director\ncompany: Ford\nsummary: Sales Director | at Ford"
  ]
};
...
async function main() {
  ...
  await runTest('Test 2: Semantic Match with Summary (THE FIX)', testCase2);
  await runTest('Test 3: Rich Document with Notes', testCase3);
