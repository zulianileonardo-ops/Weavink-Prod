...
export const SEMANTIC_SEARCH_CONFIG = {
  // Embedding model - UPDATED TO COHERE (Replaces Pinecone Inference)
  EMBEDDING_MODEL: 'embed-multilingual-v3.0', // Cohere multilingual embeddings
  EMBEDDING_DIMENSION: 1024, // 1024 dimensions (same as multilingual-e5-large)
  ...
  QDRANT_CONFIG: {
    distance: 'Cosine',  // Same metric as Pinecone
    // No cloud/region needed for self-hosted
  },
