...
import { ConsentService, CONSENT_TYPES, CONSENT_ACTIONS } from '../server/consentService.js';
...
export async function runAnalyticsConsentIntegrationTests(userId = null) {
  ...
  try {
    ...
    try {
      ...
      const consents = await ConsentService.getUserConsents(testUserId);
    ...
    try {
      ...
      await ConsentService.recordConsent(testUserId, CONSENT_TYPES.ANALYTICS_BASIC, CONSENT_ACTIONS.GRANTED, {});
    ...
    try {
      ...
      await ConsentService.recordConsent(testUserId, CONSENT_TYPES.ANALYTICS_DETAILED, CONSENT_ACTIONS.GRANTED, {});
    ...
    try {
      ...
      await ConsentService.recordConsent(testUserId, CONSENT_TYPES.COOKIES_ANALYTICS, CONSENT_ACTIONS.GRANTED, {});
    ...
    try {
      ...
      await ConsentService.withdrawConsent(testUserId, CONSENT_TYPES.ANALYTICS_DETAILED, {});
    ...
    try {
      ...
      await ConsentService.withdrawConsent(testUserId, CONSENT_TYPES.COOKIES_ANALYTICS, {});
    ...
    try {
      ...
      await ConsentService.withdrawConsent(testUserId, CONSENT_TYPES.ANALYTICS_BASIC, {});
