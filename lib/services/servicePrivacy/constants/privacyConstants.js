 ...
 */
export const DELETION_CONFIRMATION_TEXT = 'DELETE MY ACCOUNT';
...
export const PRIVACY_RATE_LIMITS = {
  ...
  ACCOUNT_DELETIONS: { max: 2, window: 3600000 }, // 2 deletion requests per hour
...
/**
 * Standardized error messages for privacy operations
 * Ensures consistent user experience and helps with i18n
 */
export const PRIVACY_ERROR_MESSAGES = {
  ...
  EXPORT_NOT_FOUND: 'Export request not found',
  EXPORT_EXPIRED: 'Export download link has expired',
  ...
  PERMISSION_UPGRADE_REQUIRED: 'This feature requires a subscription upgrade',

  // General errors
  AUTHENTICATION_REQUIRED: 'You must be authenticated to perform this action',
